...
qx.Class.define("qxl.demobrowser.demo.virtual.Tree", {
  ...
  members: {
    ...
    main() {
      ...
      tree.addListener(
        ...
        function (e) {
          ...
          var model =
            item && item.getModel ? item.getModel() : store.getModel();
          var newItem;
    ...
    getCommandFrame(tree) {
      ...
      var row = 0;
      commandFrame.add(
        new qx.ui.basic.Label("Selection: ").set({
          paddingTop: 4,
        }),
        { row: row, column: 0 }
      );
      ...
      var btnShowTopLevelOpenCloseIcons = new qx.ui.form.CheckBox(
        "Show top level open/close icons"
      );
