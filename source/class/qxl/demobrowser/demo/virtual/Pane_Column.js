 ...
 * @tag test
 */
qx.Class.define("qxl.demobrowser.demo.virtual.Pane_Column", {
  ...
  */
  ...
  members: {
    main() {
      ...
      container.add(
        new qx.ui.basic.Label("Even/Odd Colors").set({
          font: "bold",
      ...
      scroller
        .getPane()
        .addLayer(new qx.ui.virtual.layer.Column("white", "#EEE"));
      container.add(scroller, { row: 1, column: 0 });

      container.add(
        new qx.ui.basic.Label("Custom Colors").set({
          font: "bold",
          decorator: "table-scroller-header",
          padding: 3,
          allowGrowX: true,
      ...
      container.add(
        new qx.ui.basic.Label("Even/Odd & Custom Colors").set({
          font: "bold",
          decorator: "table-scroller-header",
          padding: 3,
          allowGrowX: true,
