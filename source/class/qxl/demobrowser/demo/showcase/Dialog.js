...
qx.Class.define("qxl.demobrowser.demo.showcase.Dialog", {
  ...
  members: {
    main() {
      ...
      // check boxes
      page.add(
        new qx.ui.basic.Label("Hobbies").set({
          allowShrinkX: false,
          paddingTop: 3,
        }),
        { row: 2, column: 2 }
      ...
      page.add(
        new qx.ui.form.CheckBox("Swimming").set({
          enabled: false,
        }),
        { row: 3, column: 3 }
      );
      ...
      var okButton = new qx.ui.form.Button(
        "OK",
