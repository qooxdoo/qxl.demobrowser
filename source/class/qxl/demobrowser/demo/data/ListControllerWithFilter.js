...
qx.Class.define("qxl.demobrowser.demo.data.ListControllerWithFilter", {
  ...
  members: {
    main() {
      ...
      changeFilterButton.addListener(
        "execute",
        function () {
          controller.getDelegate() == delegateOdd
            ? controller.setDelegate(delegateEven)
            : controller.setDelegate(delegateOdd);
        },
        this
      );
      ...
      removeFilterButton.addListener(
        "execute",
        function () {
