...
qx.Class.define("qxl.demobrowser.demo.widget.Tree_Columns", {
  ...
  members: {
    main() {
      ...
      var te1_2 = this.configureTreeItem(
        new qx.ui.tree.TreeFolder(),
        "Workspace"
      );
      var te1_3 = this.configureTreeItem(
        new qx.ui.tree.TreeFolder(),
        "Network"
      );
      ...
      var te1_2_1 = this.configureTreeItem(
        new qx.ui.tree.TreeFile(),
        "Windows (C:)",
        "icon/16/devices/drive-harddisk.png"
      );
      var te1_2_2 = this.configureTreeItem(
        new qx.ui.tree.TreeFile(),
        "Documents (D:)",
        "icon/16/devices/drive-harddisk.png"
      );
      ...
      var te2_1 = this.configureTreeItem(
        new qx.ui.tree.TreeFolder(),
        "Presets"
      );
      var te2_2 = this.configureTreeItem(new qx.ui.tree.TreeFolder(), "Sent");
      var te2_3 = this.configureTreeItem(
        new qx.ui.tree.TreeFolder(),
        "Trash",
      ...
      var te2_5_2 = this.configureTreeItem(
        new qx.ui.tree.TreeFolder(),
        "Pustefix"
      );
      var te2_5_3 = this.configureTreeItem(new qx.ui.tree.TreeFolder(), "TINC");
      var te2_5_3_1 = this.configureTreeItem(
        new qx.ui.tree.TreeFolder(),
        "Announce"
      );
      var te2_5_3_2 = this.configureTreeItem(
        new qx.ui.tree.TreeFolder(),
        "Devel"
      );
      ...
      var te2_6_1 = this.configureTreeItem(
        new qx.ui.tree.TreeFolder(),
        "Relations"
      );
      var te2_6_2 = this.configureTreeItem(
        new qx.ui.tree.TreeFolder(),
        "Company"
      );
      var te2_6_3 = this.configureTreeItem(
        new qx.ui.tree.TreeFolder(),
        "Questions"
      );
      var te2_6_4 = this.configureTreeItem(
        new qx.ui.tree.TreeFolder(),
        "Internal"
      );
      var te2_6_5 = this.configureTreeItem(
        new qx.ui.tree.TreeFolder(),
        "Products"
      );
      var te2_6_6 = this.configureTreeItem(
        new qx.ui.tree.TreeFolder(),
        "Press"
      );
      var te2_6_7 = this.configureTreeItem(
        new qx.ui.tree.TreeFolder(),
        "Development"
      );
      var te2_6_8 = this.configureTreeItem(
        new qx.ui.tree.TreeFolder(),
        "Competition"
      );
      te2_6.add(
      ...
      var te2_7 = this.configureTreeItem(
        new qx.ui.tree.TreeFolder(),
        "Personal"
      );
      var te2_7_1 = this.configureTreeItem(new qx.ui.tree.TreeFolder(), "Bugs");
      var te2_7_2 = this.configureTreeItem(
        new qx.ui.tree.TreeFolder(),
        "Family"
      );
      var te2_7_3 = this.configureTreeItem(
        new qx.ui.tree.TreeFolder(),
        "Projects"
      );
      var te2_7_4 = this.configureTreeItem(
        new qx.ui.tree.TreeFolder(),
        "Holiday"
      );
      ...
      for (var i = 0; i < 50; i++) {
        te2_8.add(
          this.configureTreeItem(new qx.ui.tree.TreeFolder(), "Item " + i)
        );
      }
    ...
    configureTreeItem(treeItem, vLabel, vIcon) {
      ...
      treeItem.addIcon();
      treeItem.setIcon(
        arguments.length >= 3 ? vIcon : "icon/16/places/user-desktop.png"
      );
