...
qx.Class.define("qxl.demobrowser.demo.widget.DateChooser", {
  ...
  members: {
    main() {
      ...
      var containerTop = new qx.ui.container.Composite(
        new qx.ui.layout.HBox(20)
      );
      var containerRight = new qx.ui.container.Composite(
        new qx.ui.layout.VBox(8)
      );
      var containerRightTop = new qx.ui.container.Composite(
        new qx.ui.layout.HBox(20)
      );
      var containerRightBottom = new qx.ui.container.Composite(
        new qx.ui.layout.HBox(8)
      );
      var containerButtons = new qx.ui.container.Composite(
        new qx.ui.layout.VBox(8)
      );
      var containerDescription = new qx.ui.container.Composite(
      ...
      containerDescription.add(
        new qx.ui.basic.Label("- Use the cursors keys to move the selection.")
      );
      containerDescription.add(
        new qx.ui.basic.Label(
          "- Page-keys / shift + page-keys switch months/years."
        )
      );
      containerDescription.add(
        new qx.ui.basic.Label(
          "- Double-tap or enter/space-key will fire an execute event."
        )
      );
      containerDescription.add(
        new qx.ui.basic.Label("- Escape will remove the selection.")
      );
    },
  },
});
