...
qx.Class.define("qxl.demobrowser.demo.widget.Label", {
  ...
  members: {
    main() {
      ...
      this.getRoot().add(
        this.createConfigureButton(label1, "configure text label"),
        { left: 240, top: 20 }
      );
      ...
      this.getRoot().add(
        this.createConfigureButton(label2, "configure rich label"),
        { left: 240, top: 60 }
      );
      ...
      var label4 = new qx.ui.basic.Label().set({
        value:
          "A long label text with auto-wrapping. This also may contain <b style='color:red'>rich HTML</b> markup.",
        decorator: "main",
        rich: true,
        width: 120,
      });
    ...
    createConfigureButton(widget, caption) {
    ...
    createEditDialog(widget, caption) {
      ...
      win.add(
        new qx.ui.basic.Label("value").set({
          paddingTop: 5,
        }),
        { row: 0, column: 0 }
      );
