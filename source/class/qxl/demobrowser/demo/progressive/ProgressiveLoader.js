    ...
    main() {
      ...
      progressive.addListener(
        ...
        function (e) {
          ...
          var left = Math.floor(
            (rootBounds.width - progressiveBounds.width) / 2
          );
          var top = Math.floor(
            (rootBounds.height - progressiveBounds.height) / 2
          );
        ...
        for (var row = 0; row < 20; row++) {
          ...
          dataModel.addElement(
            addFunc(function (userData) {
              ...
              context.hBox = new qx.ui.container.Composite(
