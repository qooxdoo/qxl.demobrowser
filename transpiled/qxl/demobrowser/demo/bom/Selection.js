(function () {
  ...
  ************************************************************************ */
   ...
   */
  qx.Class.define("qxl.demobrowser.demo.bom.Selection", {
    extend: qx.application.Native,
    members: {
      main: function main() {
        qxl.demobrowser.demo.bom.Selection.prototype.main.base.call(this);
        /* ***************************************
         *  SETUP
         * ************************************* */
        ...
        var setSelDocumentButton = qx.bom.Input.create("button", {
          value: "setSelectionDocument",
          style: "margin: 4px"
        });
        ...
        var getStartDocumentButton = qx.bom.Input.create("button", {
          value: "getStartSelectionDocument",
          style: "margin: 4px"
        });
        ...
        var getEndDocumentButton = qx.bom.Input.create("button", {
          value: "getEndSelectionDocument",
          style: "margin: 4px"
        });
        ...
        var inputContainer = qx.dom.Element.create("div", {
          id: "inputContainer",
          style: "width:100%;margin-bottom:20px"
        });
        qx.dom.Element.insertEnd(inputContainer, container);
        this._input = qx.bom.Input.create("text", {
          id: "textfield",
          value: "test text",
          style: "width:20%;margin-right:10px"
        });
        qx.dom.Element.insertEnd(this._input, inputContainer);
        var getSelInputButton = qx.bom.Input.create("button", {
          value: "getSelectionInput",
        ...
        var setSelInputButton = qx.bom.Input.create("button", {
          value: "setSelectionInput",
          style: "margin-right: 8px"
        });
        ...
        var getStartInputButton = qx.bom.Input.create("button", {
          value: "getStart",
          style: "margin-right: 8px"
        });
        ...
        var getEndInputButton = qx.bom.Input.create("button", {
          value: "getEnd",
          style: "margin-right: 8px"
        });
        ...
        var areaContainer = qx.dom.Element.create("div", {
          id: "areaContainer",
          style: "width:100%;margin-bottom:20px"
        });
        qx.dom.Element.insertEnd(areaContainer, container);
        this._textArea = qx.bom.Input.create("textarea", {
          id: "textarea",
          rows: 7,
          cols: 20,
          value: "test\ntest2\ntest3\ntest4\ntest5",
        ...
        var getSelTextAreaButton = qx.bom.Input.create("button", {
          value: "getSelectionTextarea",
          style: "margin-right: 8px"
        });
        ...
        var setSelTextAreaButton = qx.bom.Input.create("button", {
          value: "setSelectionTextarea",
          style: "margin-right: 8px"
        });
        ...
        var getStartTextAreaButton = qx.bom.Input.create("button", {
          value: "getStart",
          style: "margin-right: 8px"
        });
        ...
        var getEndTextAreaButton = qx.bom.Input.create("button", {
          value: "getEnd",
          style: "margin-right: 8px"
        });
        ...
        var resultLabel = qx.dom.Element.create("div", {
          style: "margin: 4px 0px"
        });
        resultLabel.innerHTML = "<strong>Results</strong>";
        var resultDiv = qx.dom.Element.create("div", {
          id: "results",
          style: "width:500px;height:200px;border:1px solid darkgrey;background-color: lightgrey"
        });
        qx.dom.Element.insertEnd(resultLabel, container);
        qx.dom.Element.insertEnd(resultDiv, container);
        var textDiv = qx.dom.Element.create("div", {
          id: "plaintext"
        });
       ...
       *  EVENT LISTENER
       * ************************************* */
      _getSelection: function _getSelection(e) {
        document.getElementById("results").innerHTML = qx.bom.Selection.get(this) + "<br/>" + qx.bom.Selection.getLength(this);
      },
      _getStart: function _getStart(e) {
        document.getElementById("results").innerHTML = qx.bom.Selection.getStart(this);
      },
      _getEnd: function _getEnd(e) {
        document.getElementById("results").innerHTML = qx.bom.Selection.getEnd(this);
      },
      _setSelection: function _setSelection(e) {
...
//# sourceMappingURL=Selection.js.map?dt=1586350623239