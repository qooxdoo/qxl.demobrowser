(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.bom.Audio", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.bom.Audio.prototype.main.base.call(this);
        ...
        if (qx.core.Environment.get("html.audio.mp3")) {
          ...
          doc.add(new qx.ui.basic.Label("It seems that your browser doesn't support HTML5 audio", {
            left: 10,
            top: 10
          }));
          return;
...
//# sourceMappingURL=Audio.js.map?dt=1586350622529