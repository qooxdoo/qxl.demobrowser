(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.bom.Blocker", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.bom.Blocker.prototype.main.base.call(this);
        var input = qx.bom.Input.create("button", {
          value: "Block Document for 5s"
        });
        ...
        var input2 = qx.bom.Input.create("button", {
          value: "Block Element for 5s"
        });
        qx.bom.element.Style.setStyles(input2, {
          position: "absolute",
          left: "320px",
          top: "100px",
          width: "200px"
        ...
        qx.bom.element.Style.setStyles(elementToBlock, {
          position: "absolute",
          left: "300px",
          top: "150px",
          width: "300px",
...
//# sourceMappingURL=Blocker.js.map?dt=1586199385436