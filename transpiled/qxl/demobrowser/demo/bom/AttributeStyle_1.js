(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.bom.AttributeStyle_1", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.bom.AttributeStyle_1.prototype.main.base.call(this);
        ...
        this.debug("title: " + attrib.get(document.getElementById("test1"), "title")); // throws exception in IE
        ...
        this.debug("bg: " + style.get(document.getElementById("test6"), "backgroundColor")); // shorthand properties are not supported
  ...
  qxl.demobrowser.demo.bom.AttributeStyle_1.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=AttributeStyle_1.js.map?dt=1586199385291