(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qxl.demobrowser.demo.widget.Slider", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.widget.Slider.prototype.main.base.call(this);
        this.getRoot().add(this._createVerticalLayout(), {
          left: 20,
          top: 20
        });
      ...
      _createVerticalLayout: function _createVerticalLayout() {
        var sliders = [];
      ...
      _createHorizontalLayout: function _createHorizontalLayout() {
        var sliders = [];
        sliders.push(this._createSliderGroup(new qx.ui.form.Slider().set({
          maximum: 1000,
          value: 100
      ...
      _createSliderGroup: function _createSliderGroup(slider) {
        var group = {
          slider: slider,
...
//# sourceMappingURL=Slider.js.map?dt=1589490218847