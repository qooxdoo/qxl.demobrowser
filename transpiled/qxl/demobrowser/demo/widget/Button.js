(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.widget.Button", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.widget.Button.prototype.main.base.call(this);
      ...
      addNormalButtons: function addNormalButtons(container) {
      ...
      addToggleButton: function addToggleButton(container) {
      ...
      addToggleButtonGroup: function addToggleButtonGroup(container) {
      ...
      addRepeatButton: function addRepeatButton(container) {
      ...
      addHoverButton: function addHoverButton(container) {
...
//# sourceMappingURL=Button.js.map?dt=1589490217898