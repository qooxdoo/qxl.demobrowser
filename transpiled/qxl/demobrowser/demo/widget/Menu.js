(function () {
  ...
  ************************************************************************ */
   ...
   */
  qx.Class.define("qxl.demobrowser.demo.widget.Menu", {
    ...
    members: {
      ...
      __pasteCommand: null,
      main: function main() {
        qxl.demobrowser.demo.widget.Menu.prototype.main.base.call(this);
        ...
        this.createCommands();
        container.add(this.getMenuButton(), {
          left: 20,
          top: 20
        });
        container.add(this.getSplitButton(), {
          left: 150,
          top: 20
        });
        ...
        container.add(this.getList(), {
          left: 20,
          top: 200
        });
        this.getRoot().setContextMenu(this.getRootContextMenu());
      },
      getRootContextMenu: function getRootContextMenu() {
      ...
      debugRadio: function debugRadio(e) {
        this.debug("Change selection: " + e.getData()[0].getLabel());
      },
      debugCommand: function debugCommand(e) {
        this.debug("Execute command: " + this.getShortcut());
      },
      debugButton: function debugButton(e) {
        this.debug("Execute button: " + this.getLabel());
      },
      debugCheckBox: function debugCheckBox(e) {
      ...
      getMenuButton: function getMenuButton() {
        ...
        actionMenu.add(new qx.ui.menu.RadioButton("Action 3")); // create radio groups
        ...
        groupActions.addListener("changeSelection", this.debugRadio); // create main menu and buttons
        ...
        var printButton = new qx.ui.menu.Button("Print", "icon/16/actions/document-print.png"); // add execute listeners
        ...
        printButton.addListener("execute", this.debugButton); // add buttons to menu
      ...
      getSplitButton: function getSplitButton() {
        ...
        menu.add(site1);
        menu.add(site2);
        menu.add(site3); // Create opener button
      ...
      getBackMenu: function getBackMenu() {
        var menu = new qx.ui.menu.Menu();
      ...
      getForwardMenu: function getForwardMenu() {
        var menu = new qx.ui.menu.Menu();
      ...
      getFileMenu: function getFileMenu() {
        var menu = new qx.ui.menu.Menu();
      ...
      getEditMenu: function getEditMenu() {
        var menu = new qx.ui.menu.Menu();
        var undoButton = new qx.ui.menu.Button("Undo", "icon/16/actions/edit-undo.png", this.__undoCommand);
        var redoButton = new qx.ui.menu.Button("Redo", "icon/16/actions/edit-redo.png", this.__redoCommand);
        var cutButton = new qx.ui.menu.Button("Cut", "icon/16/actions/edit-cut.png", this.__cutCommand);
      ...
      getSearchMenu: function getSearchMenu() {
        var menu = new qx.ui.menu.Menu();
      ...
      getViewMenu: function getViewMenu() {
        var menu = new qx.ui.menu.Menu();
      ...
      getPanesMenu: function getPanesMenu() {
        var menu = new qx.ui.menu.Menu();
      ...
      getSyntaxMenu: function getSyntaxMenu() {
        var menu = new qx.ui.menu.Menu();
        ...
        menu.add(perlButton);
        menu.add(pythonButton); // Configure and fill radio group
      ...
      getSyntaxCMenu: function getSyntaxCMenu() {
        var menu = new qx.ui.menu.Menu();
      ...
      getFormatMenu: function getFormatMenu() {
        var menu = new qx.ui.menu.Menu();
      ...
      getParagraphMenu: function getParagraphMenu() {
        var menu = new qx.ui.menu.Menu();
      ...
      getHelpMenu: function getHelpMenu() {
        var menu = new qx.ui.menu.Menu();
    ...
    destruct: function destruct() {
      this._disposeObjects("__newCommand", "__openCommand", "__saveCommand", "__undoCommand", "__redoCommand", "__cutCommand", "__copyCommand", "__pasteCommand");
    }
  });
  qxl.demobrowser.demo.widget.Menu.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Menu.js.map?dt=1589490218549