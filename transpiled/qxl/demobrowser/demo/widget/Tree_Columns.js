(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.widget.Tree_Columns", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.widget.Tree_Columns.prototype.main.base.call(this);
        ...
        root.setOpen(true);
        tree.setRoot(root); // One icon for selected and one for unselected states
        ...
        te1.add(te1_1, te1_2, te1_3, te1_4); // One icon specified, and used for both selected unselected states
      ...
      configureTreeItem: function configureTreeItem(treeItem, vLabel, vIcon) {
        ...
        treeItem.addIcon();
        treeItem.setIcon(arguments.length >= 3 ? vIcon : "icon/16/places/user-desktop.png"); // A checkbox comes right after the tree icon

        var checkbox = new qx.ui.form.CheckBox();
        checkbox.setFocusable(false);
        treeItem.addWidget(checkbox); // The label

        treeItem.addLabel(vLabel); // All else should be right justified
  ...
  qxl.demobrowser.demo.widget.Tree_Columns.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Tree_Columns.js.map?dt=1586350632208