  ...
  ************************************************************************ */
  qx.Class.define("qxl.demobrowser.demo.widget.ComboBox", {
    ...
    members: {
       ...
       */
      main: function main() {
        qxl.demobrowser.demo.widget.ComboBox.prototype.main.base.call(this); // examlpe 1: default combo box with 30 text items
      ...
      _createDefaultExample: function _createDefaultExample() {
        ...
        var comboBox = new qx.ui.form.ComboBox(); // fill the combo box with some stuff
      ...
      _createHtmlExample: function _createHtmlExample() {
        ...
        var comboBox = new qx.ui.form.ComboBox().set({
          width: 200
        });
        var items = ["... &gt; (as literal HTML entity)", "... &gt; (as Richtext)", "<b>Bold Text</b>", "<u>Underlined Text</u>", "<i>Italic Text</i>", "HTML entities: &laquo; &lt; &amp; &gt; &raquo;"]; // fill the combo box with some stuff
      ...
      _createWideExample: function _createWideExample() {
        ...
        comboBox.setWidth(300); // fill the combo box with some stuff
        ...
        comboBox.setValue(comboBox.getChildrenContainer().getSelectables()[0].getLabel()); // add the combobox to the documents root
...
//# sourceMappingURL=ComboBox.js.map?dt=1586350630879