(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.widget.TabView", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.widget.TabView.prototype.main.base.call(this);
      ...
      getTabView1: function getTabView1() {
        var tabView = new qx.ui.tabview.TabView();
        tabView.setWidth(500); ////////////////// TEST PAGE 1 ////////////////////
      ...
      getTabView2: function getTabView2() {
        var tabView = new qx.ui.tabview.TabView();
      ...
      getTabView3: function getTabView3() {
        var tabView = new qx.ui.tabview.TabView();
        tabView.setWidth(500);
        ...
        var firstPage = tabView.getChildren()[0]; // CONTROL BAR POSITION
        ...
        barLeftButton.setValue(true); // ADD/REMOVE BUTTONS
...
//# sourceMappingURL=TabView.js.map?dt=1589490218992