(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qxl.demobrowser.demo.widget.DateField", {
    extend: qx.application.Standalone,
    members: {
      main: function main() {
        qxl.demobrowser.demo.widget.DateField.prototype.main.base.call(this);
        /* Set locale to english to avoid language mix if browser locale is
         * non-english. */

        qx.locale.Manager.getInstance().setLocale("en"); // Default date field //////////////////////////////////////

        this.getRoot().add(new qx.ui.basic.Label("Default"), {
          top: 15,
          left: 20
        });
        ...
        this.getRoot().add(dateFieldFormat, {
          top: 35,
          left: 150
        });
        ...
        this.getRoot().add(setFormat1Button, {
          top: 80,
          left: 150
        });
        ...
        this.getRoot().add(setFormat2Button, {
          top: 110,
          left: 150
        });
        ...
        this.getRoot().add(setFormat3Button, {
          top: 140,
          left: 150
        });
        ...
        this.getRoot().add(resetDateButton, {
          top: 110,
          left: 280
        });
...
//# sourceMappingURL=DateField.js.map?dt=1586199392259