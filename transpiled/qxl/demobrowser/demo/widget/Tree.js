(function () {
  ...
  ************************************************************************ */
   ...
   */
  qx.Class.define("qxl.demobrowser.demo.widget.Tree", {
    extend: qx.application.Standalone,
    members: {
      main: function main() {
        qxl.demobrowser.demo.widget.Tree.prototype.main.base.call(this);
      ...
      getCommandFrame: function getCommandFrame(tree) {
        ...
        commandFrame.add(btnShowRootOpen, {
          row: row++,
          column: 1
        });
        ...
        commandFrame.add(vShowOpenItems, {
          row: row++,
          column: 1
        });
        ...
        commandFrame.add(vShowSelectedItems, {
          row: row++,
          column: 1
        });
  ...
  qxl.demobrowser.demo.widget.Tree.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Tree.js.map?dt=1589490219165