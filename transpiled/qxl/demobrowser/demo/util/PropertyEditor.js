(function () {
  var $$dbClassInfo = {
    "dependsOn": {
      ...
      "qxl.demobrowser.demo.util.LayoutPropertyGroup": {}
    }
  };
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.util.PropertyEditor", {
    ...
    construct: function construct() {
      qx.ui.core.scroll.AbstractScrollArea.constructor.call(this); // Force ScrollArea to have an auto-width
    ...
    members: {
      handleWidgetTap: function handleWidgetTap(e) {
        var widget = e.getTarget();
        this.setWidget(widget);
      },
      _createWidgetIndicator: function _createWidgetIndicator() {
      ...
      _createContainer: function _createContainer(label, mainWidget) {
        var container = new qx.ui.container.Composite(new qx.ui.layout.VBox().set({
          spacing: 5
        }));
      ...
      updateWidgetLayoutPropertyEditor: function updateWidgetLayoutPropertyEditor(widget) {
      ...
      updateLayoutPropertyEditor: function updateLayoutPropertyEditor(widget) {
      ...
      getWidgetLayoutPropertyEditor: function getWidgetLayoutPropertyEditor(layout) {
        if (!layout) {
          return null;
        }
        ...
        switch (name) {
          ...
          case "wlpe_qx.ui.layout.VBox":
            group = new qxl.demobrowser.demo.util.LayoutPropertyGroup(qxl.demobrowser.demo.util.LayoutPropertyGroup.BOX_PROPERTIES);
            break;

          case "wlpe_qx.ui.layout.Canvas":
            group = new qxl.demobrowser.demo.util.LayoutPropertyGroup(qxl.demobrowser.demo.util.LayoutPropertyGroup.CANVAS_PROPERTIES);
            break;

          case "wlpe_qx.ui.layout.Basic":
            group = new qxl.demobrowser.demo.util.LayoutPropertyGroup(qxl.demobrowser.demo.util.LayoutPropertyGroup.BASIC_PROPERTIES);
            break;

          case "wlpe_qx.ui.layout.Dock":
            group = new qxl.demobrowser.demo.util.LayoutPropertyGroup(qxl.demobrowser.demo.util.LayoutPropertyGroup.DOCK_PROPERTIES);
            break;

          case "wlpe_qx.ui.layout.Grid":
            group = new qxl.demobrowser.demo.util.LayoutPropertyGroup(qxl.demobrowser.demo.util.LayoutPropertyGroup.GRID_PROPERTIES);
            break;
        }
      ...
      getLayoutPropertyEditor: function getLayoutPropertyEditor(layout) {
        if (!layout) {
          return null;
        }
        ...
        switch (name) {
          case "lpe_qx.ui.layout.HBox":
            group = new qxl.demobrowser.demo.util.PropertyGroup(qxl.demobrowser.demo.util.PropertyGroup.HBOX_PROPERTIES);
            break;

          case "lpe_qx.ui.layout.Dock":
            group = new qxl.demobrowser.demo.util.PropertyGroup(qxl.demobrowser.demo.util.PropertyGroup.DOCK_PROPERTIES);
            break;

          case "lpe_qx.ui.layout.Grid":
            group = new qxl.demobrowser.demo.util.PropertyGroup(qxl.demobrowser.demo.util.PropertyGroup.GRID_PROPERTIES);
            break;
        }
      ...
      _applyWidget: function _applyWidget(value, old) {
    ...
    destruct: function destruct() {
      this._pane = this._editorGroups = this._widgetIndicator = this._layoutControls = null;
    }
  });
  qxl.demobrowser.demo.util.PropertyEditor.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=PropertyEditor.js.map?dt=1586199390899