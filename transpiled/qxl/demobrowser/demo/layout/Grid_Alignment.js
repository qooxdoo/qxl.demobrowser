(function () {
  ...
  ************************************************************************ */
   ...
   * @tag noPlayground
   */
  qx.Class.define("qxl.demobrowser.demo.layout.Grid_Alignment", {
    extend: qxl.demobrowser.demo.util.LayoutApplication,
    members: {
      main: function main() {
        qxl.demobrowser.demo.layout.Grid_Alignment.prototype.main.base.call(this);
        ...
        container.add(this.getCellAlignGrid(), {
          row: 0,
          column: 0
        });
        container.add(this.getRowColumnAlignGrid(), {
          row: 0,
          column: 1
        });
        container.add(this.getColumnAlignGrid(), {
          row: 0,
          column: 2
        });
        container.add(this.getRowAlignGrid(), {
          row: 1,
          column: 0
        });
      },
      getNewWidget: function getNewWidget() {
      ...
      getColumnAlignGrid: function getColumnAlignGrid() {
      ...
      getRowAlignGrid: function getRowAlignGrid() {
        var box = new qx.ui.container.Composite().set({
          decorator: "main",
          backgroundColor: "yellow",
          allowGrowX: false,
      ...
      getCellAlignGrid: function getCellAlignGrid() {
        var box = new qx.ui.container.Composite().set({
          decorator: "main",
          backgroundColor: "yellow",
          allowGrowX: false,
      ...
      getRowColumnAlignGrid: function getRowColumnAlignGrid() {
...
//# sourceMappingURL=Grid_Alignment.js.map?dt=1586350625649