(function () {
  ...
  ************************************************************************ */
  ...
  /**
   * Identical to DockLayout 1 but adds demonstration for spacings.
   * @tag noPlayground
   */
  qx.Class.define("qxl.demobrowser.demo.layout.Dock_AutoSize", {
    extend: qxl.demobrowser.demo.util.LayoutApplication,
    members: {
      main: function main() {
        qxl.demobrowser.demo.layout.Dock_AutoSize.prototype.main.base.call(this);
...
//# sourceMappingURL=Dock_AutoSize.js.map?dt=1586199387720