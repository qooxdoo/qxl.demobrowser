(function () {
  ...
  ************************************************************************ */
   ...
   * @tag noPlayground
   */
  qx.Class.define("qxl.demobrowser.demo.layout.Dock_FlexShrinking", {
    extend: qxl.demobrowser.demo.util.LayoutApplication,
    members: {
      main: function main() {
        qxl.demobrowser.demo.layout.Dock_FlexShrinking.prototype.main.base.call(this);
        ...
        scroll.add(container); // default layout, flex shrinking
        ...
        container.add(widget); // y-axis first, flex shrinking
        ...
        container.add(widget); // x-axis first, flex shrinking
...
//# sourceMappingURL=Dock_FlexShrinking.js.map?dt=1589490213596