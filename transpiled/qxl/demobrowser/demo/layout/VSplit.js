(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qxl.demobrowser.demo.layout.VSplit", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.layout.VSplit.prototype.main.base.call(this);
        ...
        scroll.add(root); // Two Flex Tests

        root.add(this.getSplitPaneTwoFlexSimple(), {
          left: 0
        });
        root.add(this.getSplitPaneTwoFlexWithOneMin(), {
          left: 210
        });
        root.add(this.getSplitPaneTwoFlexWithOneMax(), {
          left: 420
        });
        root.add(this.getSplitPaneTwoFlexWithTwoMin(), {
          left: 630
        });
        root.add(this.getSplitPaneTwoFlexWithTwoMax(), {
          left: 840
        }); // One Flex Test

        root.add(this.getSplitPaneOneFlexSimple(), {
          top: 550,
          left: 0
        });
      ...
      getSplitPaneTwoFlexWithOneMin: function getSplitPaneTwoFlexWithOneMin() {
        var splitpane = new qx.ui.splitpane.Pane("vertical");
        splitpane.setHeight(400);
        splitpane.setDecorator("main"); // Left
      ...
      getSplitPaneTwoFlexWithOneMax: function getSplitPaneTwoFlexWithOneMax() {
        var splitpane = new qx.ui.splitpane.Pane("vertical");
        splitpane.setHeight(400);
        splitpane.setDecorator("main"); // Left
      ...
      getSplitPaneTwoFlexWithTwoMin: function getSplitPaneTwoFlexWithTwoMin() {
        var splitpane = new qx.ui.splitpane.Pane("vertical");
        splitpane.setHeight(400);
        splitpane.setDecorator("main"); // Left
      ...
      getSplitPaneTwoFlexWithTwoMax: function getSplitPaneTwoFlexWithTwoMax() {
        var splitpane = new qx.ui.splitpane.Pane("vertical");
        splitpane.setHeight(400);
        splitpane.setDecorator("main"); // Left
      ...
      getSplitPaneOneFlexSimple: function getSplitPaneOneFlexSimple() {
        var splitpane = new qx.ui.splitpane.Pane("vertical");
        splitpane.setHeight(400);
        splitpane.setDecorator("main"); // Left
        ...
        topWidget.setDecorator(null);
        topWidget.setWrap(true);
        splitpane.add(topWidget, 0); // Right
      ...
      getSplitPaneOneFlexSimpleWithMax: function getSplitPaneOneFlexSimpleWithMax() {
        var splitpane = new qx.ui.splitpane.Pane("vertical");
        splitpane.setHeight(400);
        splitpane.setDecorator("main"); // Left
      ...
      getSplitPaneOneFlexSimpleWithMin: function getSplitPaneOneFlexSimpleWithMin() {
        var splitpane = new qx.ui.splitpane.Pane("vertical");
        splitpane.setHeight(400);
        splitpane.setDecorator("main"); // Left
      ...
      getSplitPaneAuto: function getSplitPaneAuto() {
        var splitpane = new qx.ui.splitpane.Pane("vertical");
        splitpane.setDecorator("main"); // Left
...
//# sourceMappingURL=VSplit.js.map?dt=1589490214582