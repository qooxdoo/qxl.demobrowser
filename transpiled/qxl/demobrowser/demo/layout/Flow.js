(function () {
  ...
  ************************************************************************ */
   ...
   */
  qx.Class.define("qxl.demobrowser.demo.layout.Flow", {
    ...
    */
    members: {
       ...
       */
      main: function main() {
        qxl.demobrowser.demo.layout.Flow.prototype.main.base.call(this);

        this._createGalleryWindow(20, 20);

        this._createLineBreakWindow(160, 50);
      },
      _createGalleryWindow: function _createGalleryWindow(left, top) {
      ...
      _createLineBreakWindow: function _createLineBreakWindow(left, top) {
        ...
        var button2 = new qx.ui.form.Button("2. Second longer Button...", icon); // Have this child create a break in the current Line (next child will always start a new Line)
...
//# sourceMappingURL=Flow.js.map?dt=1589490213725