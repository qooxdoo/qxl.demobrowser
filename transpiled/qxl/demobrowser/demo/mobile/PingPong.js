  ...
  qx.Class.define("qxl.demobrowser.demo.mobile.PingPong", {
    ...
    */
    members: {
      ...
      main: function main() {
        // Call super class
        qxl.demobrowser.demo.mobile.PingPong.prototype.main.base.call(this); // Enable logging in debug variant
        ...
        root.add(rightField); // Paddles

        this.__leftPaddle = this.__createPaddle("left");

        this.__leftField.add(this.__leftPaddle);

        this.__leftField.addListener("pointermove", qx.lang.Function.bind(this.__onPointerMove, this), this);

        this.__rightPaddle = this.__createPaddle("right");
        rightField.add(this.__rightPaddle);
        rightField.addListener("pointermove", qx.lang.Function.bind(this.__onPointerMove, this), this); // Ball

        this.__ball = this.__createBall();
        root.add(this.__ball); // Scores
        ...
        rightField.add(this.__scoreDivRight); // initialize score

        this.__score = [0, 0]; // START
      ...
      ---------------------------------------------------------------------------
      */
      __startGame: function __startGame() {
        // set ball start position
        this.__ball.setStyles({
          "left": "200px",
          "top": "200px"
        }); // ball movement
      ...
      __restartGame: function __restartGame(player) {
      ...
      __detectColision: function __detectColision() {
        var ballBounds = this.getBoundsFor(this.__ball); // top wall
      ...
      ---------------------------------------------------------------------------
      */
      __onPointerMove: function __onPointerMove(e) {
        var paddle;
      ...
      ---------------------------------------------------------------------------
      */
      __createField: function __createField(side) {
        var styles = {
          "width": "50%",
          "height": "100%",
          "position": "absolute",
      ...
      __createPaddle: function __createPaddle(side) {
        var styles = {
          "width": "30px",
          "height": "100px",
          "top": "100px",
      ...
      __createBall: function __createBall() {
        var styles = {
          "width": "20px",
          "height": "20px",
          "position": "absolute",
      ...
      __createScore: function __createScore() {
        var styles = {
          "width": "100%",
          "height": "100%",
          "textAlign": "center",
...
//# sourceMappingURL=PingPong.js.map?dt=1589490214656