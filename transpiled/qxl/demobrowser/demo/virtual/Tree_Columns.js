(function () {
  var $$dbClassInfo = {
    "dependsOn": {
      ...
      "qxl.demobrowser.demo.virtual.tree.TreeItem": {}
    }
  };
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.virtual.Tree_Columns", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.virtual.Tree_Columns.prototype.main.base.call(this);
        ...
        var model = qx.data.marshal.Json.createModel(data, true); // configure model for triState usage

        this.configureTriState(model); // data binding
      ...
      configureTriState: function configureTriState(item) {
        ...
        if (item.getChildren != null) {
          ...
          for (var i = 0; i < children.getLength(); i++) {
            ...
            this.configureTriState(child); // bind parent with child

            item.bind("checked", child, "checked", {
              converter: function converter(value, child) {
            ...
            child.bind("checked", item, "checked", {
              converter: function converter(value, parent) {
  ...
  qxl.demobrowser.demo.virtual.Tree_Columns.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Tree_Columns.js.map?dt=1586350630409