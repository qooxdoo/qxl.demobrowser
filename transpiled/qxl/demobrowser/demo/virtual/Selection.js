(function () {
  ...
  ************************************************************************ */
   ...
   * @tag test
   */
  qx.Class.define("qxl.demobrowser.demo.virtual.Selection", {
    ...
    */
    members: {
      ...
      main: function main() {
        // Call super class
        qxl.demobrowser.demo.virtual.Selection.prototype.main.base.call(this);
      ...
      createRowSelectionScroller: function createRowSelectionScroller() {
      ...
      createColumnSelectionScroller: function createColumnSelectionScroller() {
        var scroller = new qx.ui.virtual.core.Scroller(1000, 100, 20, 100);
      ...
      createCellRectangleSelectionScroller: function createCellRectangleSelectionScroller() {
        var scroller = new qx.ui.virtual.core.Scroller(1000, 100, 20, 100);
        scroller.getPane().addLayer(new qx.ui.virtual.layer.Row("white", "#EEE"));
        var cellRenderer = new qx.ui.virtual.cell.Cell();
      ...
      createCellLineSelectionScroller: function createCellLineSelectionScroller() {
        var scroller = new qx.ui.virtual.core.Scroller(1000, 100, 20, 100);
        scroller.getPane().addLayer(new qx.ui.virtual.layer.Row("white", "#EEE"));
        var cellRenderer = new qx.ui.virtual.cell.Cell();
        var selectedCell = new qx.ui.virtual.cell.Cell().set({
  ...
  qxl.demobrowser.demo.virtual.Selection.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Selection.js.map?dt=1586350630202