(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.showcase.Browser", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.showcase.Browser.prototype.main.base.call(this);
        this.getRoot().add(this._createBrowser(), {
          left: 40,
          top: 30
        });
      },
      _createBrowser: function _createBrowser() {
        var win = new qx.ui.window.Window("Web Browser", "icon/16/categories/internet.png");
...
//# sourceMappingURL=Browser.js.map?dt=1589490214802