  ...
  qx.Class.define("qxl.demobrowser.demo.table.Table_Context_Menu", {
    ...
    members: {
      main: function main() {
        ...
        qxl.demobrowser.demo.table.Table_Context_Menu.prototype.main.base.call(this); // Allow showing the native contextmenu
      ...
      createTable: function createTable() {
        ...
        tableModel.setColumns(["Default ctx menu #1", "Default ctx menu #2", "Disabled ctx menu", "Context-menu selectable"]);
        ...
        tcm.setDataCellRenderer(3, new qx.ui.table.cellrenderer.Boolean()); // Establish a context menu for the boolean field, to select its value

        table.setContextMenuHandler(3, this._contextMenuHandlerBoolean); // Prevent display of the browser context menu handler in column 2
       ...
       */
      _contextMenuHandlerBoolean: function _contextMenuHandlerBoolean(col, row, table, dataModel, contextMenu) {
        // Add our two choices
        var menuEntry;
       ...
       *   Menu in which buttons can be added to implement this context menu.
       */
      _contextMenuHandlerNull: function _contextMenuHandlerNull(col, row, table, dataModel, contextMenu) {
...
//# sourceMappingURL=Table_Context_Menu.js.map?dt=1586350627508