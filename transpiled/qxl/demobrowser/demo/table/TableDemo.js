(function () {
  var $$dbClassInfo = {
    "dependsOn": {
      ...
      "qxl.demobrowser.demo.table.MUtil": {
        "require": true
      },
      "qx.locale.Manager": {},
      "qx.ui.window.Window": {},
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.table.TableDemo", {
    ...
    members: {
      __dlg: null,
      main: function main() {
        qxl.demobrowser.demo.table.TableDemo.prototype.main.base.call(this);
      ...
      showDialog: function showDialog(text) {
        if (!this.__dlg) {
          ...
          dlg.add(new qx.ui.basic.Image("icon/32/status/dialog-information.png"), {
            row: 0,
            column: 0
          });
  ...
  qxl.demobrowser.demo.table.TableDemo.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=TableDemo.js.map?dt=1589490215238