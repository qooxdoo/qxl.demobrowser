  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.table.Table_Events", {
    ...
    members: {
      ...
      main: function main() {
        qxl.demobrowser.demo.table.Table_Events.prototype.main.base.call(this);
      ...
      createTable: function createTable() {
        ...
        table.getSelectionModel().setSelectionMode(qx.ui.table.selection.Model.MULTIPLE_INTERVAL_SELECTION); // Display a checkbox in column 3

        var tcm = table.getTableColumnModel();
        tcm.setDataCellRenderer(3, new qx.ui.table.cellrenderer.Boolean());

        var logTableEvent = function logTableEvent(e) {
          this._events.addRows([[e.getType(), "", "", ""]], 0);
        };

        var logCellEvent = function logCellEvent(e) {
          this._events.addRows([[e.getType(), e.getRow(), e.getColumn()]], 0);
        };

        var logSortedEvent = function logSortedEvent(e) {
          var data = e.getData();

          this._events.addRows([[e.getType(), data.ascending ? "asc" : "desc", data.columnIndex]], 0);
        };
...
//# sourceMappingURL=Table_Events.js.map?dt=1586350627600