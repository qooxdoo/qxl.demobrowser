  ...
  qx.Class.define("qxl.demobrowser.demo.table.Table_Resize_Columns", {
    ...
    members: {
      ...
      createTable: function createTable() {
        ...
        tableModel.setData(rowData); // Customize the table column model.  We want one that automatically
        // resizes columns.
        ...
        var resizeBehavior = tcm.getBehavior(); // This uses the set() method to set all attriutes at once; uses flex
        ...
        resizeBehavior.setMaxWidth(1, 320); // Display a checkbox in column 3
...
//# sourceMappingURL=Table_Resize_Columns.js.map?dt=1586199389782