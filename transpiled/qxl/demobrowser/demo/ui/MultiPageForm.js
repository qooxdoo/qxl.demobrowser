  ...
  ************************************************************************ */
  qx.Class.define("qxl.demobrowser.demo.ui.MultiPageForm", {
    ...
    members: {
       ...
       */
      main: function main() {
        qxl.demobrowser.demo.ui.MultiPageForm.prototype.main.base.call(this); // create the ui ///////////////////////
        ...
        backButton.addListener("execute", stack.previous, stack); // submit
        ...
        var model = qx.data.marshal.Json.createModel(skeleton, true); // create the controller and connect all fields
        ...
        controller.addTarget(birthDate, "value", "birthdate", true); // invoke the serialization
        ...
        validator.add(birthDate); // validate on every change of the model

        model.addListener("changeBubble", function (e) {
          validator.validate();
        }, this); // invoke the inital validate

        validator.validate(); // switch the submit button on and off
...
//# sourceMappingURL=MultiPageForm.js.map?dt=1589490216394