(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.ui.FormRendererCustom", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.ui.FormRendererCustom.prototype.main.base.call(this); // create the form

        var form = new qx.ui.form.Form(); // add the first headline

        form.addGroupHeader("Registration"); // add user name
        ...
        form.addGroupHeader("Contact"); // add some additional widgets

        form.add(new qx.ui.form.TextField(), "Email", qx.util.Validate.email(), "email", null, {
  ...
  qx.Class.define("qxl.demobrowser.demo.ui.CustomRenderer", {
    ...
    members: {
      ...
      addItems: function addItems(items, names, title, options) {
        ...
        this.__column += 2; // save the max row height for the buttons
  ...
  qxl.demobrowser.demo.ui.FormRendererCustom.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=FormRendererCustom.js.map?dt=1586350628509