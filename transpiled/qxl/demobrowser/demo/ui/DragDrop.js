  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.ui.DragDrop", {
    ...
    members: {
      ...
      main: function main() {
        qxl.demobrowser.demo.ui.DragDrop.prototype.main.base.call(this);
        ...
        source.addListener("dragstart", function (e) {
          ...
          e.addType("value");
          e.addType("items"); // Register supported actions
        ...
        targetSimple.addListener("drop", function (e) {
          this.debug("Related of drop: " + e.getRelatedTarget()); // Move items from source to target
        ...
        this.getRoot().add(indicator); // Just add a move action
        ...
        both.addListener("drag", function (e) {
          var orig = e.getOriginalTarget(); // store the current listitem - if the user drops on the indicator
      ...
      __reorderList: function __reorderList(listItem, reorderItem) {
...
//# sourceMappingURL=DragDrop.js.map?dt=1586199390174