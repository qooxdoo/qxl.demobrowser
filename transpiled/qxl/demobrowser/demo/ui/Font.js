(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qxl.demobrowser.demo.ui.Font", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.ui.Font.prototype.main.base.call(this);
        ...
        var controls = new qx.ui.container.Composite(new qx.ui.layout.VBox().set({
          spacing: 10
        }));
        this.getRoot().add(controls, {
          left: 200,
          top: 20
        });
...
//# sourceMappingURL=Font.js.map?dt=1589490216095