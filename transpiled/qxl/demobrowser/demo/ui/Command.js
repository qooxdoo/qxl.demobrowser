(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.ui.Command", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.ui.Command.prototype.main.base.call(this); // create and configure the command
        ...
        menu.add(menuSaveButton); // add a toolbar
        ...
        toolbar.add(tbutton); // add a container for the content
        ...
        var desc = "You can see three buttons in this window:\n  Button in the menu\n  Button in the toolbar\n  Button in the content at the bottom\nEach of the buttons is configured using the same command and have the same execute listener.";
        textarea.setValue(desc);
      }
    }
  });
  qxl.demobrowser.demo.ui.Command.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Command.js.map?dt=1586350628159