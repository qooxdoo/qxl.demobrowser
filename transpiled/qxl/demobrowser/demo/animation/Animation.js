(function () {
  ...
  ************************************************************************ */
   ...
   */
  qx.Class.define("qxl.demobrowser.demo.animation.Animation", {
    extend: qx.application.Native,
    members: {
      main: function main() {
        qxl.demobrowser.demo.animation.Animation.prototype.main.base.call(this); // check for annimation support
        ...
        for (var test in tests) {
          ...
          document.body.appendChild(button); // check for transforms
          ...
          q(button).on("tap", function (animation, test) {
            return function (e) {
  ...
  qxl.demobrowser.demo.animation.Animation.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Animation.js.map?dt=1586199385026