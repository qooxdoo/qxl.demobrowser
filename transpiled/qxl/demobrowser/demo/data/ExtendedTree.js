(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.data.ExtendedTree", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.data.ExtendedTree.prototype.main.base.call(this);
        var colors = ["red", "blue", "green", "black", "gray", "yellow"]; // create the data
        ...
        for (var i = 0; i < 50; i++) {
          ...
          nodes[i].setColor(colors[i % 6]); // if its not the root node
        ...
        description.setValue("<b>A tree configures with bindItem</b><br/>The tree has bound its label to the name of the modeln and its textColor to some random colors.");
...
//# sourceMappingURL=ExtendedTree.js.map?dt=1586199386305