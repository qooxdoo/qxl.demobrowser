(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.data.OwnCodeInModel", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.data.OwnCodeInModel.prototype.main.base.call(this); // create and add the list
        ...
        controller.setIconPath("type"); // create the store delegate
        ...
        var store = new qx.data.store.Json(url, delegate); // connect the store and the controller
        ...
        this.getRoot().add(sortByTypeButton, {
          left: 130,
          top: 80
        });
        ...
        this.getRoot().add(sortByNameButton, {
          left: 130,
          top: 110
        });
        ...
        syncListDescription.setValue("<b>Adding own code to the model</b><br/>Using the delegation to bring two sort function to the root model class of this demo. The buttons just calling those sort functions.");
...
//# sourceMappingURL=OwnCodeInModel.js.map?dt=1589490212730