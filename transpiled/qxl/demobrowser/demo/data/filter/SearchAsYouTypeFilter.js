  ...
  ************************************************************************ */
  qx.Class.define("qxl.demobrowser.demo.data.filter.SearchAsYouTypeFilter", {
    ...
    construct: function construct(controller) {
      qx.core.Object.constructor.call(this); // store the controller

      this.__controller = controller; // apply the filter funtion on creation time because the 'this' context
...
//# sourceMappingURL=SearchAsYouTypeFilter.js.map?dt=1586350624695