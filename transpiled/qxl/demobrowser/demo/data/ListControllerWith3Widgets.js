(function () {
  ...
  ************************************************************************ */
   ...
   * @tag databinding
   */
  qx.Class.define("qxl.demobrowser.demo.data.ListControllerWith3Widgets", {
    extend: qx.application.Standalone,
    members: {
      main: function main() {
        qxl.demobrowser.demo.data.ListControllerWith3Widgets.prototype.main.base.call(this); // create the data
        ...
        var comboBox = new qx.ui.form.ComboBox(); // add the widgets to the document
        ...
        new qx.data.controller.List(data, comboBox); // sync the selections of the list and the selectbox
        ...
        this.getRoot().add(selectBoxDescription, {
          left: 130,
          top: 10
        ...
        this.getRoot().add(comboBoxDescription, {
          left: 260,
          top: 10
        }); // Common Description
        ...
        commonDescription.setValue("All 3 widgets share the same data model. The List and the SelectBox also share the same selection.");
        this.getRoot().add(commonDescription, {
          left: 20,
          top: 30
        });
      }
...
//# sourceMappingURL=ListControllerWith3Widgets.js.map?dt=1586199386660