(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.data.ListControllerWithObjects", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.data.ListControllerWithObjects.prototype.main.base.call(this); // names
        ...
        controller.setIconPath("emote"); // create the options for the online binding
        ...
        var delegate = {
          bindItem: function bindItem(controller, item, id) {
            controller.bindDefaultProperties(item, id); // 1. Parameter: The property chain to the data source
        ...
        syncListDescription.setValue("<b>Displaying objects in a list</b><br/>This list display a set of persons in a list. Every person does have a name and an emotion, which is displayed with the help of  a converter by the icon. The font color shows the online status.");
...
//# sourceMappingURL=ListControllerWithObjects.js.map?dt=1589490212604