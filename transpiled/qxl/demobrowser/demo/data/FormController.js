(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.data.FormController", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.data.FormController.prototype.main.base.call(this); // create the UI ///////////////////
        // groupbox
        ...
        var form = new qx.ui.form.Form(); // add the form items
        ...
        form.add(new qx.ui.form.DateField(), "Date"); // buttons
        ...
        form.addButton(cancelButton); // create the view
...
//# sourceMappingURL=FormController.js.map?dt=1586199386469