  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.event.MouseEvent_LowLevel", {
    ...
    members: {
      ...
      main: function main() {
        qxl.demobrowser.demo.event.MouseEvent_LowLevel.prototype.main.base.call(this);
        ...
        for (var i = 0; i < events.length; i++) {
          ...
          if (elem.checked) {
            qx.bom.Event.addNativeListener(mouseDiv, events[i], this.__logMouseEventWrapper);
          }
      ...
      __changeCheckbox: function __changeCheckbox(e) {
        ...
        if (checked) {
          qx.bom.Event.addNativeListener(mouseDiv, type, this.__logMouseEventWrapper);
        } else {
          qx.bom.Event.removeNativeListener(mouseDiv, type, this.__logMouseEventWrapper);
        }
      },
...
//# sourceMappingURL=MouseEvent_LowLevel.js.map?dt=1586350625074