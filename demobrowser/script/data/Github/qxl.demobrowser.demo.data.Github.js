...
qx.Class.define("qxl.demobrowser.demo.data.Github", {
  ...
  members: {
    ...
    _createGui() {
      var dockContainer = new qx.ui.container.Composite(
    ...
    _setUpBinding() {
      ...
      list.setLabelOptions({
        converter(label, model, source, target) {
...
qx.Class.define("github.view.Gist", {
  ...
  construct() {
    ...
    // Description
    var descriptionContainer = new qx.ui.container.Composite(
