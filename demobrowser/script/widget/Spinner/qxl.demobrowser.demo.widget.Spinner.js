...
qx.Class.define("qxl.demobrowser.demo.widget.Spinner", {
  ...
  members: {
    addSimpleSpinner(container, row) {
    ...
    addNonEditableSpinner(container, row) {
    ...
    addWrappingSpinner(container, row) {
    ...
    addSteppedSpinner(container, row) {
    ...
    addDisabledSpinner(container, row) {
      var spinner = new qx.ui.form.Spinner();
    ...
    addFormattedSpinner(container, row) {
