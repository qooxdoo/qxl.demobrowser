...
qx.Class.define("qxl.demobrowser.demo.widget.Atom", {
    ...
    main() {
      ...
      container1.add(
        new qx.ui.basic.Atom(
          "Icon Left",
          "icon/32/actions/go-previous.png"
        ).set({
      ...
      container1.add(
        new qx.ui.basic.Atom("Icon Top", "icon/32/actions/go-up.png").set({
          backgroundColor: "#E6FAED",
          decorator: "main",
          iconPosition: "top",
          padding: 5,
      ...
      container1.add(
        new qx.ui.basic.Atom("Icon Right", "icon/32/actions/go-next.png").set({
          backgroundColor: "#E6FAED",
          decorator: "main",
          iconPosition: "right",
          padding: 5,
      ...
      container1.add(
        new qx.ui.basic.Atom("Icon Bottom", "icon/32/actions/go-down.png").set({
          backgroundColor: "#E6FAED",
          decorator: "main",
          iconPosition: "bottom",
          padding: 5,
      ...
      container1.add(
        new qx.ui.basic.Atom(
          "Atom Without Label",
          "icon/32/apps/internet-feed-reader.png"
        ).set({
      ...
      container2.add(
        new qx.ui.basic.Atom("Atom With Long Label").set({
      ...
      container3.add(
        new qx.ui.basic.Atom("Wider Atom").set({
          backgroundColor: "#E6EDFA",
          decorator: "main",
          center: true,
          padding: 5,
      ...
      container3.add(
        new qx.ui.basic.Atom(
          "Wider Atom",
          "icon/32/apps/utilities-notes.png"
        ).set({
          backgroundColor: "#E6EDFA",
          decorator: "main",
          center: true,
