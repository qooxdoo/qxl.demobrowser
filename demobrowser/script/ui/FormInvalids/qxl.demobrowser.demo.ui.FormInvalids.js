...
qx.Class.define("qxl.demobrowser.demo.ui.FormInvalids", {
  ...
  members: {
    main() {
      ...
      widgets.push(
        new qx.ui.form.CheckBox().set({ triState: true, value: null })
      );
      ...
      var disableTooltipButton = new qx.ui.form.ToggleButton(
        "disable tooltips"
      );
      this.getRoot().add(disableTooltipButton, { left: 450, top: 20 });

      disableTooltipButton.addListener(
        "changeValue",
        function (e) {
          qx.ui.tooltip.Manager.getInstance().setShowInvalidToolTips(
            !e.getData()
          );
        },
        this
      ...
      listDescription.setValue(
        "<b>Validation</b><br/>Press the button to" +
