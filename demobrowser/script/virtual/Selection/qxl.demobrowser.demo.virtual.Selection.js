  ...
  */
  ...
  members: {
    ...
    main() {
      ...
      // Row selection
      container.add(
        new qx.ui.basic.Label("Row Selection").set({
          font: "bold",
      ...
      // Column selection
      container.add(
        new qx.ui.basic.Label("Column Selection").set({
          font: "bold",
          decorator: "table-scroller-header",
          padding: 3,
          allowGrowX: true,
      ...
      container.add(
        new qx.ui.basic.Label("Cell Rectangle Selection").set({
          font: "bold",
          decorator: "table-scroller-header",
          padding: 3,
          allowGrowX: true,
      ...
      // Cell line selection
      container.add(
        new qx.ui.basic.Label("Cell Line Selection").set({
          font: "bold",
          decorator: "table-scroller-header",
          padding: 3,
          allowGrowX: true,
      ...
      controls.add(
        new qx.ui.basic.Label("Selection Mode").set({
          font: "bold",
          padding: 3,
        }),
        { row: 0, column: 0 }
      ...
      controls.add(
        new qx.ui.basic.Label("Options").set({
          font: "bold",
          padding: 3,
        }),
        { row: 0, column: 1 }
    ...
    createCellRectangleSelectionScroller() {
      var scroller = new qx.ui.virtual.core.Scroller(1000, 100, 20, 100);
      ...
      var manager = new qx.ui.virtual.selection.CellRectangle(
        scroller.getPane(),
        {
          styleSelectable(item, type, wasAdded) {
            cellLayer.updateLayerData();
    ...
    createCellLineSelectionScroller() {
      var scroller = new qx.ui.virtual.core.Scroller(1000, 100, 20, 100);
