...
qx.Class.define("qxl.demobrowser.demo.table.Table_Filtered_Model", {
  ...
  members: {
    ...
    createControls() {
      ...
      var button1 = new qx.ui.toolbar.Button(
        "Hide True",
      ...
      button1.addListener("execute", function (e) {
        ...
        table.setAdditionalStatusBarText(
          ", additional Status. True Values are hidden."
        );
      });

      var button2 = new qx.ui.toolbar.Button(
        "Hide False",
        "icon/22/actions/list-remove.png"
      );
      part.add(button2);
      button2.addListener("execute", function (e) {
        ...
        tableModel.applyFilters();
        table.setAdditionalStatusBarText(
          ", additional Status. False Values are hidden."
        );
      });

      var button3 = new qx.ui.toolbar.Button(
        "Hide 1k-5k",
        "icon/22/actions/list-remove.png"
      );
      part.add(button3);
      button3.addListener("execute", function (e) {
        ...
        tableModel.applyFilters();
        table.setAdditionalStatusBarText(
          ", additional Status. 1k - 5k Values are hidden."
        );
      });

      var button4 = new qx.ui.toolbar.Button(
        "Show All",
      ...
      button4.addListener("execute", function (e) {
        ...
        table.setAdditionalStatusBarText(
          ", additional Status. All Values are shown."
        );
      });
