  ...
  members: {
    ...
    main() {
      ...
      for (var i = 0; i < locales.length; i++) {
        ...
        select.add(listItem);
        if (
          (!defaultListItem && locales[i] == "en") ||
          locales[i] == currentLocale
        ) {
      ...
      var infoContainer = new qx.ui.container.Composite(
        new qx.ui.layout.VBox(3)
      );
      ...
      qx.locale.Manager.getInstance().addListener(
        ...
        function () {
          ...
          addTrLabel.setValue(
            "Add translation<br>at runtime for: <b>" +
      ...
      function translateLabels() {
        ...
        var applesNumber = parseInt(
          numberOfApples.getSelection()[0].getLabel()
        );
        translation2.setValue(
          this.trn(
            "I have an apple",
            "I have %1 apples",
            applesNumber,
        ...
        translation2.setToolTipText(
          "Singular/Plural Translate: this.trn('I have an apple', I have %1 apples, " +
            applesNumber +
            ", applesNumber)"
        );
        translation3.setValue(
          this.trc("The mammal fox that is.", "The quick brown fox")
        );
        translation3.setToolTipText(
          "with .po comment: this.trc('The mammal fox that is.', 'The quick brown fox')"
        );
        translation4.setValue(this.marktr("Orange"));
        translation4.setToolTipText(
          "Mark the string 'Orange' for later translation so we do not forget it: this.marktr('Orange')"
        );
        var messageId = showMessageId.getValue();
        if (messageId && messageId.length > 0) {
          showTrLabel.setValue(
            localeManager.translate(messageId, [], localeManager.getLocale())
          );
        }
      }

      var part1Label = new qx.ui.basic.Label(
        "<b>Static translation [found in .po files]. Hover the labels below to see more info.</b>"
      );
      ...
      var translation1Info = new qx.ui.basic.Label(
        "Simple messageId translation"
      );
      container.add(translation1Info, { row: 4, column: 3 });

      // Singular/Plural Translate
      var appleNumberSelectBoxLabel = new qx.ui.basic.Label(
        "Number of apples:"
      );
      ...
      var translation2 = new qx.ui.basic.Label(
        this.trn("I have an apple", "I have %1 apples", 1, 1)
      );
      translation2.setAlignY("middle");
      container.add(translation2, { row: 5, column: 2, rowSpan: 2 });

      var translation2Info = new qx.ui.basic.Label(
        "Singular/Plural Translate<br>Choose a number from the select box<br>to see plural translation"
      );
      ...
      var translation3 = new qx.ui.basic.Label(
        this.trc("The mammal fox that is.", "The quick brown fox")
      );
      translation3.setWidth(140);
      container.add(translation3, { row: 7, column: 2 });

      var translation3Info = new qx.ui.basic.Label(
        "A comment: 'The mammal fox that is.'<br>is added in the .po file"
      );
      ...
      var translation4Info = new qx.ui.basic.Label(
        "Mark the string 'Orange' for later<br>translation so we do not forget it"
      );
      translation4Info.setRich(true);
      container.add(translation4Info, { row: 8, column: 3 });

      var part2Label = new qx.ui.basic.Label(
        "<b>Dynamic translation. This is added at runtime.</b>"
      );
      part2Label.setRich(true);
      part2Label.setMarginTop(15);
      container.add(part2Label, { row: 9, column: 0, colSpan: 3 });

      var addTrLabel = new qx.ui.basic.Label(
        "Add translation<br>at runtime for: <b>" +
          localeManager.getLocale() +
          "</b>"
      );
      ...
      addTranslationButton.addListener(
        "execute",
        function (e) {
          var map = {};
          ...
          alert(
            inputDTranslation.getValue() +
              " has been added for messageId: " +
              inputMessageId.getValue() +
              " for locale: " +
              localeManager.getLocale()
          );
        },
      ...
      showTranslationButton.addListener(
        "execute",
        function (e) {
          var messageId = showMessageId.getValue();
          showTrLabel.setValue(
      ...
      var showTrLabel = new qx.ui.basic.Label(
        "tap 'Show Translation' button to translate<br>the messageId in the current selected locale"
      );
      showTrLabel.setRich(true);
      showTrLabel.setAlignY("middle");
      container.add(showTrLabel, { row: 11, column: 3 });

      var addNewLocaleLabel = new qx.ui.basic.Label(
        "Add new Locale<br> at runtime"
      );
      ...
      addNewLocaleButton.addListener(
        "execute",
        function (e) {
