 ...
 */
qx.Class.define("qxl.demobrowser.demo.showcase.Localization", {
  ...
  */
  ...
  members: {
    ...
    main() {
      ...
      controls.add(new qx.ui.basic.Label(this.tr("Localized ComboBox:")), {
        row: 1,
        column: 0,
      });
      ...
      m1.add(
        new qx.ui.menu.Button(this.tr("Select All"), null, select_all_cmd)
      );
      m1.add(new qx.ui.menu.Separator());
      m1.add(new qx.ui.menu.Button(this.tr("Search"), null, search_cmd));
      m1.add(
        new qx.ui.menu.Button(this.tr("Search Again"), null, search_again_cmd)
      );

      var w1 = new qx.ui.form.MenuButton(
        this.tr("Command Menu (keyboard shortcuts)"),
        null,
        m1
      );
      ...
      // Info Box
      var w2 = new qx.ui.window.Window(
        "Locale Information",
        "icon/16/actions/edit-find.png"
      ).set({
        showClose: false,
        showMinimize: false,
      });
      ...
      this.updateLocaleInformation = function () {
        ...
        info[i++ * 2 + 1] = new qx.util.format.DateFormat(
        ...
        info[i++ * 2 + 1] = new qx.util.format.DateFormat(
          qx.locale.Date.getDateFormat("full")
        ).format(new Date());
        ...
        info[i++ * 2 + 1] = new qx.util.format.DateFormat(
          qx.locale.Date.getTimeFormat("long")
        ).format(new Date());

        info[i++ * 2 + 1] = this.tr("Week start:");
        info[i++ * 2 + 1] = qx.locale.Date.getDayName(
          "wide",
