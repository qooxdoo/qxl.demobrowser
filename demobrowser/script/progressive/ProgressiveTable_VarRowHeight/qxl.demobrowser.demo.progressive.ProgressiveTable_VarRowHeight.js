 ...
 */
qx.Class.define(
  "qxl.demobrowser.demo.progressive.ProgressiveTable_VarRowHeight",
  {
    ...
    members: {
      ...
      doLoad() {
        ...
        // Add a message
        var message = new qx.ui.basic.Atom(
          "Note variable row heights in this table."
        );
